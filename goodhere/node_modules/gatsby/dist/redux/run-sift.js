...
const getBucketsForFilters = (filters, nodeTypeNames, typedKeyValueIndexes) => {
  ...
  /*: DbQuery*/
    ...
    ensureIndexByTypedChain(cacheKey, chain, nodeTypeNames, typedKeyValueIndexes);
    const nodesByKeyValue = getNodesByTypedChain(cacheKey, targetValue, typedKeyValueIndexes); // If we couldn't find the needle then maybe sift can, for example if the
