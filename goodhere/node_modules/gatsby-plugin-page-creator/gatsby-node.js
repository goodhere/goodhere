...
exports.createPagesStatefully = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(_ref2, _ref3, doneCb) {
    var store, actions, reporter, pagesPath, _ref3$pathCheck, pathCheck, ignore, createPage, deletePage, program, exts, pagesDirectory, pagesGlob, files;

    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            store = _ref2.store, actions = _ref2.actions, reporter = _ref2.reporter;
            pagesPath = _ref3.path, _ref3$pathCheck = _ref3.pathCheck, pathCheck = _ref3$pathCheck === void 0 ? true : _ref3$pathCheck, ignore = _ref3.ignore;
