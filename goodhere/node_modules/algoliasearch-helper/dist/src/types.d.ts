...
import algoliasearch, { SearchClient as SearchClientV4, Client as SearchClientV3, QueryParameters as SearchOptionsV3, Response as SearchResponseV3 } from 'algoliasearch';
import { SearchOptions as SearchOptionsV4, SearchResponse as SearchResponseV4 } from '@algolia/client-search';
import { EventEmitter } from 'events';
declare type DummySearchClientV4 = {
    readonly addAlgoliaAgent: (segment: string, version?: string) => void;
};
export declare type Client = ReturnType<typeof algoliasearch> extends DummySearchClientV4 ? SearchClientV4 : SearchClientV3;
declare type SearchOptions = Client extends DummySearchClientV4 ? SearchOptionsV4 : SearchOptionsV3;
declare type SearchResponse<T> = Client extends DummySearchClientV4 ? SearchResponseV4<T> : SearchResponseV3<T>;
declare type SearchClient = Pick<Client, 'search' | 'searchForFacetValues'>;
/**
 ...
 * @param opts
 */
declare function algoliasearchHelper(client: SearchClient, index: string, opts?: algoliasearchHelper.PlainSearchParameters): algoliasearchHelper.AlgoliaSearchHelper;
declare namespace algoliasearchHelper {
    const version: string;
    type AlgoliaSearchHelperConstructor = (client: Client, index: string, options: SearchParameters) => void;
    class AlgoliaSearchHelper extends EventEmitter {
        ...
        on(event: 'search', cb: (res: {
            state: SearchParameters;
            results: SearchResults;
        }) => void): this;
        on(event: 'change', cb: (res: {
            state: SearchParameters;
            results: SearchResults;
            isPageReset: boolean;
        }) => void): this;
        on(event: 'searchForFacetValues', cb: (res: {
            state: SearchParameters;
            facet: string;
            query: string;
        }) => void): this;
        on(event: 'searchOnce', cb: (res: {
            state: SearchParameters;
        }) => void): this;
        on(event: 'result', cb: (res: {
            results: SearchResults;
            state: SearchParameters;
        }) => void): this;
        on(event: 'error', cb: (res: {
            error: Error;
        }) => void): this;
         ...
         * }
         */
        searchOnce(options: PlainSearchParameters): Promise<{
            content: SearchResults;
            state: SearchParameters;
        }>;
        searchOnce(options: PlainSearchParameters, cb: (error: Error, content: SearchResults, state: SearchParameters) => void): void;
        /**
         ...
         */
        searchForFacetValues(facet: string, query: string, maxFacetHits: number, userState?: PlainSearchParameters): Promise<SearchForFacetValues.Result>;
        /**
        ...
        derive(deriveFn: (oldParams: SearchParameters) => SearchParameters): DerivedHelper;
    ...
    interface DerivedHelper extends EventEmitter {
        ...
        fn: (searchParameters: SearchParameters) => SearchParameters;
        lastResults: SearchResults | null;
        detach(): void;
        getModifiedState(state: any): SearchParameters;
    }
    ...
    interface PlainSearchParameters extends SearchOptions {
        /**
    ...
    class SearchParameters implements PlainSearchParameters {
        ...
        clearRefinements(attribute?: string | ((value: any, attribute: string, type: string) => void)): SearchParameters;
        ...
        removeNumericRefinement(attribute: string, operator?: string, value?: string): SearchParameters;
        ...
        static validate(currentState: SearchParameters, parameters: PlainSearchParameters): null | Error;
        /**
    ...
    class SearchResults<T = any> implements Omit<SearchResponse<T>, 'facets' | 'params'> {
        /**
         ...
         * });
         */
        getFacetValues(attribute: string, opts: any): SearchResults.FacetValue[] | SearchResults.HierarchicalFacet | undefined;
        /**
    ...
    namespace SearchResults {
        ...
        interface Refinement {
            type: 'numeric' | 'facet' | 'exclude' | 'disjunctive' | 'hierarchical' | 'tag';
