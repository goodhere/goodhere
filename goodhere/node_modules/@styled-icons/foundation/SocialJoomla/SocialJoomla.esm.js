...
export var SocialJoomla = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(StyledIconBase, __assign({ iconAttrs: attrs, iconVerticalAlign: "middle", iconViewBox: "0 0 100 100" }, props, { ref: ref }),
        ...
        React.createElement("path", { d: "M22.564 33.799c-1.655 6.861.583 12.263 5.552 16.803 2.381 2.176 4.605 4.527 6.86 6.837 2.244 2.299 4.438 4.646 6.653 6.97l6.918-6.839c-.526-.554-1-1.065-1.489-1.563-4.568-4.649-9.164-9.274-13.7-13.955-2.186-2.256-2.243-5.441-.27-7.695 2.055-2.347 5.236-2.633 7.811-.705.34.255.69.496.633.455l6.786-6.805c-3.857-3.83-8.686-5.32-14.261-4.3-2.728-6.083-5.454-8.083-10.412-7.681-3.768.305-7.274 3.067-8.018 6.787-1.162 5.824 1.469 9.659 6.937 11.691z", key: "k2" })));
});
SocialJoomla.displayName = 'SocialJoomla';
export var SocialJoomlaDimensions = { height: 24, width: 24 };
